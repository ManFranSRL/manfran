...
// Redes sociales — hrefs pendientes de confirmar con Franco/Manuel
export const SOCIAL = [
  {
    label: 'LinkedIn',
    href: '#',
...
export const HERO = {
  rotatingWords: ['Movemos', 'Entregamos'],
  slogan: {
    line2: 'tu carga.',
    accentLines: ['en todo el', 'mundo.'],
  },
}

export const FOOTER = {
  copyrightPrefix: 'Copyright ©',
  copyrightSuffix: 'ManFran S.R.L. Todos los derechos reservados.',
  // hrefs pendientes — páginas legales aún no existen
  legal: [
...
// Logos de clientes — se repiten en el doble carrusel hasta llenar el ancho.
// Pendiente: ampliar la lista cuando Franco apruebe más clientes.
export const CLIENTS = [
  // `invert: true` para logos oscuros (texto/marca en negro) que no se verían
  // sobre el bg #111111 — los invierte a blanco silueta.
  { name: 'Diesel Tellier', src: '/assets/clients/diesel_tellier_logo.png', invert: true },
  { name: 'Grupo Eslabón', src: '/assets/clients/grupo_eslabon_logo.png' },
  { name: 'Guido', src: '/assets/clients/logo-guido-blanco.svg' },
  { name: 'Marcela Koury', src: '/assets/clients/marcela-koury-logo.svg' },
]
...
export const COOKIE = {
  textBefore:
    'Al hacer clic en “Aceptar”, aceptás que se almacenen cookies en tu dispositivo para mejorar la navegación del sitio, analizar el uso del sitio y ayudarnos con nuestras acciones de marketing. Consultá nuestra ',
  privacyLabel: 'Política de Privacidad',
  textAfter: ' para más información.',
  accept: 'Aceptar',
  reject: 'Rechazar',
}
